...
const getCurrentTurn = () => (game?.turn() === 'w' ? 'White' : 'Black');
...
borderBottomWidth: 1, borderBottomColor: '#e8e8e8', minHeight: 60
},
...
drawButton: { backgroundColor: 'transparent', borderWidth: 1, borderColor: '#228B22' },
...
undoButton: { backgroundColor: '#2563eb' },
resetButton: { backgroundColor: '#6b21a8' },
